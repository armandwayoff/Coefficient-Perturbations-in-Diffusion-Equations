...
plt1_2222 ,= axs[0].semilogy(x[start2:], y1_2222[start2:], '-s', linewidth=linew, color=[cvalr, 0.0, 0.0], markerfacecolor=[mfcvalr, 0.0, 0.0], markersize=markersize3)
plt2_2222 ,= axs[0].semilogy(x[start1:], y2_2222[start1:], '-s', linewidth=linew, color=[0.0, 0.0, cvalb], markerfacecolor=[0.0, 0.0, mfcvalb], markersize=markersize3)
plt25_2222 ,= axs[0].semilogy(x[start1:], y25_2222[start1:], '-s', linewidth=linew, color=[cvalr, 0.0, cvalb], markerfacecolor=[mfcvalr, 0.0, mfcvalb], markersize=markersize3)
plt3_2222 ,= axs[0].semilogy(x[start1:], y3_2222[start1:], '-s', linewidth=linew, color=[0.0, cvalg, 0.0], markerfacecolor=[0.0, mfcvalg, 0.0], markersize=markersize3)
plt4_2222 ,= axs[0].semilogy(x[start1:], y4_2222[start1:], '-s', linewidth=linew, color=[0.0, cvalg, cvalb], markerfacecolor=[0.0, mfcvalg, mfcvalb], markersize=markersize3)
plt5_2222 ,= axs[0].semilogy(x[start1:], y5_2222[start1:], '-s', linewidth=linew, color=[cvalr, cvalg, 0.0], markerfacecolor=[mfcvalr, mfcvalg, 0.0], markersize=markersize3)

plt1_4321 ,= axs[1].semilogy(x[start2:], y1_4321[start2:], '-d', linewidth=linew, color=[cvalr, 0.0, 0.0], markerfacecolor=[mfcvalr, 0.0, 0.0], markersize=markersize3)
plt2_4321 ,= axs[1].semilogy(x[start1:], y2_4321[start1:], '-d', linewidth=linew, color=[0.0, 0.0, cvalb], markerfacecolor=[0.0, 0.0, mfcvalb], markersize=markersize3)
plt25_4321 ,= axs[1].semilogy(x[start1:], y25_4321[start1:], '-d', linewidth=linew, color=[cvalr, 0.0, cvalb], markerfacecolor=[mfcvalr, 0.0, mfcvalb], markersize=markersize3)
plt3_4321 ,= axs[1].semilogy(x[start1:], y3_4321[start1:], '-d', linewidth=linew, color=[0.0, cvalg, 0.0], markerfacecolor=[0.0, mfcvalg, 0.0], markersize=markersize3)
plt4_4321 ,= axs[1].semilogy(x[start1:], y4_4321[start1:], '-d', linewidth=linew, color=[0.0, cvalg, cvalb], markerfacecolor=[0.0, mfcvalg, mfcvalb], markersize=markersize3)
plt5_4321 ,= axs[1].semilogy(x[start1:], y5_4321[start1:], '-d', linewidth=linew, color=[cvalr, cvalg, 0.0], markerfacecolor=[mfcvalr, mfcvalg, 0.0], markersize=markersize3)

plt1_1234 ,= axs[2].semilogy(x[start2:], y1_1234[start2:], '-o', linewidth=linew, color=[cvalr, 0.0, 0.0], markerfacecolor=[mfcvalr, 0.0, 0.0], markersize=markersize3)
plt2_1234 ,= axs[2].semilogy(x[start1:], y2_1234[start1:], '-o', linewidth=linew, color=[0.0, 0.0, cvalb], markerfacecolor=[0.0, 0.0, mfcvalb], markersize=markersize3)
plt25_1234 ,= axs[2].semilogy(x[start1:], y25_1234[start1:], '-o', linewidth=linew, color=[cvalr, 0.0, cvalb], markerfacecolor=[mfcvalr, 0.0, mfcvalb], markersize=markersize3)
plt3_1234 ,= axs[2].semilogy(x[start1:], y3_1234[start1:], '-o', linewidth=linew, color=[0.0, cvalg, 0.0], markerfacecolor=[0.0, mfcvalg, 0.0], markersize=markersize3)
plt4_1234 ,= axs[2].semilogy(x[start1:], y4_1234[start1:], '-o', linewidth=linew, color=[0.0, cvalg, cvalb], markerfacecolor=[0.0, mfcvalg, mfcvalb], markersize=markersize3)
plt5_1234 ,= axs[2].semilogy(x[start1:], y5_1234[start1:], '-o', linewidth=linew, color=[cvalr, cvalg, 0.0], markerfacecolor=[mfcvalr, mfcvalg, 0.0], markersize=markersize3)
...
for axis in axs:
    ...
    axis.grid(axis='both', which='minor', ls='dotted', alpha=1)
...
plt.savefig("vspatternsize_multipoint_inversion_fusion.pgf") # save as PGF file which can be used in your document via `\input`

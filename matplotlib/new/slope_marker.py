# https://github.com/tonysyu/mpltools/blob/master/mpltools/annotation/_slopemarker.py
...
def slope_marker(origin, slope, slope_legend, run_legend, invert=False, size_frac=0.25, pad_frac=0.05,
    ...
    if ax.get_yscale() == 'log':
        ...
        y_run = _text_position(y0, -dx_decades*slope*pad_frac*4, scale='log')
    ...
    if rise is not None:
        ax.text(x_run, y_run, run_legend, va=va, ha='center', **text_kwargs)
        ax.text(x_rise, y_rise, slope_legend, ha=ha, va='center', **text_kwargs)

...
for p in probabilities:
    ...
    for step in range(Nsamples):
        ...
        norm_ref_solution = error('L2', P4.uh)
        error_hat =  error('L2', P4.uh, P6.uh)
        error_star = error('L2', P4.uh, P7.uh)
        error_bar = error('L2', P4.uh, P8.uh)

        """
        print("A_hat", error_hat)
        print("A_star", error_star)
        print("A_bar", error_bar)
        """
        # norms_ref_solution.append(norm_ref_solution)

        """
        errors_hat.append(error_hat)
        errors_star.append(error_star)
        errors_bar.append(error_bar)
        """

        errors_hat.append(error_hat / norm_ref_solution)
        errors_star.append(error_star / norm_ref_solution)
        errors_bar.append(error_bar / norm_ref_solution)
        ...
        """
    count += 1
    print(count, "/", num_proba)

    RMSE_hat.append(rmse(errors_hat))
    RMSE_star.append(rmse(errors_star))
    RMSE_bar.append(rmse(errors_bar))

print(RMSE_hat)
print(RMSE_star)
print(RMSE_bar)

plt.plot(probabilities, RMSE_hat)
plt.plot(probabilities, RMSE_star)
plt.plot(probabilities, RMSE_bar)
